                    ...
                    <div class="form-card">
                        ...
                        <form @submit.prevent="submitForm" class="form-body">
                            <div class="form-group">
                                <label>Имя *</label>
                                <input v-model="form.name" type="text" required placeholder="Введите ваше имя"
                                    class="form-input" :class="{ 'error': errors.name }">
                            ...
                            <div class="form-group">
                                ...
                                <textarea v-model="form.message" required placeholder="Опишите ваш вопрос или проект..."
                                    rows="5" class="form-textarea" :class="{ 'error': errors.message }"></textarea>
                            ...
                            <button type="submit" class="btn btn-primary" :class="{ 'btn-loading': isLoading }"
                                :disabled="isLoading">
